...
contract L2StandardBridge is StandardBridge, Semver {
    ...
    /// @param _metis Address of the Metis token (L2StandardBridge to address(0)).
    constructor(address payable _otherBridge, address _metis)
        Semver(1, 1, 1)
        StandardBridge(payable(Predeploys.L2_CROSS_DOMAIN_MESSENGER), _otherBridge, _metis)
    {}
